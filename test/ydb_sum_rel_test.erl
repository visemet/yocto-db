...
%% @doc This module tests the SUM aggregate function for relations.
...
get_diff_tuples() ->
    ...
    Table1 = {[{ydb_tuple,2,{13}}],[]}
  , Table2 = {[{ydb_tuple,3,{18}}],[{ydb_tuple,2,{13}}]}
  , Table3 = {[{ydb_tuple,4,{12}}],[{ydb_tuple,3,{18}}]}
...
get_diff_tables() ->
  ...
  , ets:insert(Diff1, {'+', {row, 2}, {ydb_tuple, 2, {10}}})
  ...
  , ets:insert(Diff3, {'-', {row, 2}, {ydb_tuple, 2, {10}}})
